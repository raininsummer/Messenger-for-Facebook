...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static final String KEY_PREF_FAB_BTN = "hide_fab_btn";
    ...
    public static final String KEY_PREF_ADS = "hide_ads_app";
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (!PreferenceManager.getDefaultSharedPreferences(this).getBoolean(SettingsActivity.KEY_PREF_ADS, false)) {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    AdHelper.popUpAd(SettingsActivity.this);
                }
            }, 1000 * 2);
        }
    }

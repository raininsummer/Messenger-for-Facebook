...
class WebViewListener implements AdvancedWebView.Listener {
    ...
    public void onPageFinished(String url) {
        ...
        if (mActivity.checkLoggedInState()) {
            ...
            // Hide the menu bar (but not on the composer)
            if (url.equals("https://m.facebook.com/") || url.contains("/home.php")) {
                isHideFAB = false;
...
//        intentBuilder.setStartAnimations(mActivity, R.anim.fab_slide_in_from_right, R.anim.fab_slide_out_to_left);
//        intentBuilder.setExitAnimations(mActivity, R.anim.fab_slide_in_from_left, R.anim.fab_slide_out_to_right);
    ...
    public void onScrollChange(int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
        ...
        if (mPreferences.getBoolean(SettingsActivity.KEY_PREF_FAB_SCROLL, false) && Math.abs(oldScrollY - scrollY) > mScrollThreshold && !mPreferences.getBoolean(SettingsActivity.KEY_PREF_FAB_BTN, false)) {
